...
% Forms the distance matrix of two sets of points in R"s, % i.e., DM(i,j) = I I datasite_i - center_j I I_2. % Input
% dsites: Mxs matrix representing a set of M data sites in R~s 7, (i.e., each row contains one s-dimensional point)
% ctrs: Nxs matrix representing a set of N centers in R~s 7o (one center per row)
% Output
